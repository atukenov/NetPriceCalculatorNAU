...
Calculator.calculate = function () {
	...
	var roomAndBoard;
		...
		if (housing == 'offcampus') roomAndBoard = 9882;
	var booksAndSupplies = 1122;
	var transportationAndOther;
		if (housing == 'oncampus') transportationAndOther = 1031 + 2332;
		if (housing == 'offcampus') transportationAndOther = 2570 + 2332;
		if (housing == 'other') transportationAndOther = 2062 + 2332;
