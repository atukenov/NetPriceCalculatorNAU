/*
 * This is deck.navigation.js, modified by Leon Lin 2011-10-16.
 */
	...
	*/
	...
	$d.bind('deck.init', function() {
		...
		.bind('click.decknavigation', function(e) {
			...
			// validate any forms on the slide; if fail, don't proceed to next slide
			var $currentSlide = $[deck]('getSlide');
			if ($currentSlide.children('form').size() > 0) {
				if (!$currentSlide.children('form').valid())
					return;
			} 
